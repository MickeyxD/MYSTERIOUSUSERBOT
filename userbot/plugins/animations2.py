...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](MYSTERIOUS-OS/MYSTERIOUSBOT)**",
        ...
        "__INFO:MYSTERIOUSBOT:Logged in as 557667062__",
        "__INFO:MYSTERIOUSBOT:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
