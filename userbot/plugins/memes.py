...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/MYSTERIOUS-OS/MYSTERIOUSBOT) to open this 🔥**Lit AF!!**🔥 __MYSTERIOUSBOT__ Repo.. Join channel :- @MYSTERIOUS_EMPIRE")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the MYSTERIOUS" + "ツ")
