...
CmdHelp("thumbnail").add_command(
  "sthumb", "<reply to media>", "Saves the thumbnail of replied media to MYSTERIOUSBOT download directory. To get the thumbnail type .upload ./DOWNLOADS/thumb_image.jpg"
).add_command(
