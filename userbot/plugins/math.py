...
# KEEP CREDIT
# MADE FOR MYSTERIOUSBOT
# BY TEAM MYSTERIOUSBOT
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="sin ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="cos ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="tan ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="sec ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="cot ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="square ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@MYSTERIOUSBOT.on(admin_cmd(pattern="cube ?(.*)"))
@MYSTERIOUSBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
