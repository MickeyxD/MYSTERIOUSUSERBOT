...
async def stats(
    ...
    MYSTERIOUS = await edit_or_reply(event, "`Collecting stats...`")
    ...
    response += (
        f"ƒɾσɱ ƭɦε ∂αƭαɓαรε σƒ:-[♥️✞︎t͛ẞ̸ 𝖑𝖊ɠêɳ̃dẞø✞︎♥️](https://t.me/MYSTERIOUS_EMPIRE)"
    )
    await MYSTERIOUS.edit(response)
